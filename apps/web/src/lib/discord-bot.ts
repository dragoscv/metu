...
export const DISCORD_COMMANDS: DiscordCommand[] = [
  ...
  { name: 'tasks', description: 'List your open tasks', type: 1 },
  { name: 'task', description: 'Add a task to your inbox', type: 1, options: [{ name: 'text', description: 'Task title', type: 3, required: true }] },
  { name: 'done', description: 'Complete a task by number', type: 1, options: [{ name: 'number', description: 'Task number from /tasks', type: 3, required: true }] },
