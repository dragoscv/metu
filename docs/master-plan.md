...
| 6   | Companion advanced (v1.5)              | window tracking, clipboard, file watcher, wake-word, Ollama tunnel                                                                                                                      | **partial** — frontend clipboard ring + Porcupine wake-word adapter shipped; openWakeWord runner, Rust window/file watchers, and Ollama tunnel still pending |
